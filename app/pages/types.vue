    ...
    <section class="page-intro">
      <UContainer>
        <div class="page-intro__grid">
          ...
          <p>
            Название типа строится по аспектам базовой и творческой функций и признаку экстраверсии или интроверсии.
            Типы собраны по квадрам. На карточках показан блок Эго — функции 1 и 2.
          </p>
        </div>
